...
export const getAllUsers = createAsyncThunk(
  ...
  async (i, { rejectWithValue }) => {
    try {
      const users = await axios.get(`${PRO_URL}/users`);
...
export const getCurrentUser = createAsyncThunk(
  ...
  async (slug: any, { rejectWithValue }) => {
    try {
      const currentUser = await axios.get(`${PRO_URL}/users/find/${slug}`);
  ...
  async ({ userId, form }: UpdateProps, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        `${PRO_URL}/users/update/profile/${userId}`,
        { form: form }
      );
  ...
  async (userId: string, { rejectWithValue }) => {
    try {
      const requests = await axios.get(
        `${PRO_URL}/users/request/all/${userId}`
      );
...
export const sendConnectionReq = createAsyncThunk(
  ...
  async (
    ...
    try {
      const response = await axios.patch(`${PRO_URL}/users/send-request`, {
...
export const declineReq = createAsyncThunk(
  ...
  async ({ userId, connectId }: ReqActionProps, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`${PRO_URL}/request/decline`, {
        userId,
        connectId,
      });
      return response?.data;
...
export const acceptReq = createAsyncThunk(
  ...
  async ({ userId, connectId }: ReqActionProps, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`${PRO_URL}/request/accept`, {
        userId,
        connectId,
      });
      return response?.data;
...
export const unconnectUser = createAsyncThunk(
  ...
  async ({ userId, connectId }: ReqActionProps, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`${PRO_URL}/request/unconnect`, {
        userId,
        connectId,
      });
      return response?.data;
...
export const updateCurrentUserProfile = createAsyncThunk(
  ...
  async ({ userId, image }: UpdateProp, { rejectWithValue }) => {
    try {
      const response = await axios.patch(
        `${PRO_URL}/users/update/userprofile/${userId}`,
        { image }
      );
      return response?.data;
    } catch (error: any) {
